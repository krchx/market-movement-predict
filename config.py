...
class Config:
    ...
    HORIZON = 10                     # Prediction horizon (e.g., number of minutes into the future)

    # --- Model Parameters ---
    CNN_CHANNELS = 64               # Number of output channels for the CNN layers
    RNN_HIDDEN = 128                 # Number of hidden units in the RNN (GRU or LSTM) layers
